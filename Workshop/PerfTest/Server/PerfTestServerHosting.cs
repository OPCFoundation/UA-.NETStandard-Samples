...
using System;
using Opc.Ua;
using Quickstarts.PerfTestServer;

namespace Microsoft.Extensions.DependencyInjection
{
    /// <summary>
    /// The composition root of the PerfTest server sample: the server class, its
    ...
    /// </remarks>
    public static class PerfTestServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "PerfTestServer.Config.xml";

        /// <summary>
        /// Registers the PerfTest server as the hosted OPC UA server of the stack,
        ...
        public static IServiceCollection AddPerfTestServer(
            this IServiceCollection services,
            string configurationFile = null,
            Action<ApplicationConfiguration> configure = null)
        {
            return services.AddSampleServer<PerfTestServer>(
                configurationFile ?? ConfigurationFile,
                server => server.AddNodeManager<PerfTestNodeManagerFactory>(),
                configure);
        }
    }
}