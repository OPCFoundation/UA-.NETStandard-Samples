...
{
    /// <summary>
    /// The composition root of the PerfTest client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddPerfTestServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class PerfTestClientHosting
    {
        /// <summary>
        /// Registers the client model of the PerfTest sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddPerfTestClient(this IServiceCollection services)
        {
            services.TryAddSingleton<PerfTestClientModel>();
