...
using System;
using Opc.Ua;
using Quickstarts.AlarmConditionServer;

namespace Microsoft.Extensions.DependencyInjection
{
    /// <summary>
    /// The composition root of the AlarmCondition server sample: the server class, its
    ...
    /// </remarks>
    public static class AlarmConditionServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "AlarmConditionServer.Config.xml";

        /// <summary>
        /// Registers the AlarmCondition server as the hosted OPC UA server of the stack,
        ...
        public static IServiceCollection AddAlarmConditionServer(
            this IServiceCollection services,
            string configurationFile = null,
            Action<ApplicationConfiguration> configure = null)
        {
            return services.AddSampleServer<AlarmConditionServer>(
