...
{
    /// <summary>
    /// The composition root of the AlarmCondition client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddAlarmConditionServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class AlarmConditionClientHosting
    {
        /// <summary>
        /// Registers the client model of the AlarmCondition sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddAlarmConditionClient(this IServiceCollection services)
        {
            services.TryAddSingleton<AlarmConditionClientModel>();
