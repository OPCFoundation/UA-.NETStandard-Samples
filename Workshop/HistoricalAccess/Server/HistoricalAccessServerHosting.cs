...
using System;
using Opc.Ua;
using Quickstarts.HistoricalAccessServer;

namespace Microsoft.Extensions.DependencyInjection
{
    /// <summary>
    /// The composition root of the HistoricalAccess server sample: the server class, its
    ...
    /// </remarks>
    public static class HistoricalAccessServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "HistoricalAccessServer.Config.xml";

        /// <summary>
        /// Registers the HistoricalAccess server as the hosted OPC UA server of the stack,
        ...
        public static IServiceCollection AddHistoricalAccessServer(
            this IServiceCollection services,
            string configurationFile = null,
            Action<ApplicationConfiguration> configure = null)
        {
            return services.AddSampleServer<HistoricalAccessServer>(
