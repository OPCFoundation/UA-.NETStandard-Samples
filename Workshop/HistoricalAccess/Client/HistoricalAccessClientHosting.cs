...
{
    /// <summary>
    /// The composition root of the HistoricalAccess client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddHistoricalAccessServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class HistoricalAccessClientHosting
    {
        /// <summary>
        /// Registers the client model of the HistoricalAccess sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddHistoricalAccessClient(this IServiceCollection services)
        {
            services.TryAddSingleton<HistoricalAccessClientModel>();
