...
using System;
using Opc.Ua;
using Quickstarts.NodeManagement.Server;

namespace Microsoft.Extensions.DependencyInjection
{
    /// <summary>
    /// The composition root of the NodeManagement server sample: the server class, its
    ...
    /// </remarks>
    public static class NodeManagementServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "Quickstarts.NodeManagementServer.Config.xml";

        /// <summary>
        /// Registers the NodeManagement server as the hosted OPC UA server of the stack,
        ...
        public static IServiceCollection AddNodeManagementServer(
            this IServiceCollection services,
            string configurationFile = null,
            Action<ApplicationConfiguration> configure = null)
        {
            return services.AddSampleServer<NodeManagementServer>(
                configurationFile ?? ConfigurationFile,
                server => server.AddNodeManager<NodeManagementNodeManagerFactory>(),
                configure);
        }
    }
}