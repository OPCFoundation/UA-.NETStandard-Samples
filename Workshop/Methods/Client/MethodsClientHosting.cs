...
{
    /// <summary>
    /// The composition root of the Methods client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddMethodsServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class MethodsClientHosting
    {
        /// <summary>
        /// Registers the client model of the Methods sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddMethodsClient(this IServiceCollection services)
        {
            services.TryAddSingleton<MethodsClientModel>();
