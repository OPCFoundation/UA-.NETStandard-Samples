...
{
    /// <summary>
    /// The composition root of the Aggregation client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddAggregationServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class AggregationClientHosting
    {
        /// <summary>
        /// Registers the client model of the Aggregation sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddAggregationClient(this IServiceCollection services)
        {
            services.TryAddSingleton<AggregationClientModel>();
