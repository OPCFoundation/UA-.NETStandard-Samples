...
{
    /// <summary>
    /// The composition root of the AliasNames client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddAliasNamesServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class AliasNamesClientHosting
    {
        /// <summary>
        /// Registers the client model of the AliasNames sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddAliasNamesClient(this IServiceCollection services)
        {
            services.TryAddSingleton<AliasNamesClientModel>();
