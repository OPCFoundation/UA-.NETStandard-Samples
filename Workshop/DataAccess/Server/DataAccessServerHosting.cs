...
{
    /// <summary>
    /// The composition root of the DataAccess server sample: the server class, its
    ...
    /// </remarks>
    public static class DataAccessServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "DataAccessServer.Config.xml";

        /// <summary>
        /// Registers the DataAccess server as the hosted OPC UA server of the stack,
        ...
        public static IServiceCollection AddDataAccessServer(
            this IServiceCollection services,
            string configurationFile = null,
            Action<ApplicationConfiguration> configure = null)
        {
            return services.AddSampleServer<DataAccessServer>(
                configurationFile ?? ConfigurationFile,
                server => server.AddNodeManager<DataAccessServerNodeManagerFactory>(),
                configure);
        }
    }
}