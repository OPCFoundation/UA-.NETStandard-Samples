...
{
    /// <summary>
    /// The composition root of the DataAccess client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddDataAccessServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class DataAccessClientHosting
    {
        /// <summary>
        /// Registers the client model of the DataAccess sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddDataAccessClient(this IServiceCollection services)
        {
            services.TryAddSingleton<DataAccessClientModel>();
