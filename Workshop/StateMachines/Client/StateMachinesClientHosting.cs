...
{
    /// <summary>
    /// The composition root of the StateMachines client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddStateMachinesServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class StateMachinesClientHosting
    {
        /// <summary>
        /// Registers the client model of the StateMachines sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddStateMachinesClient(this IServiceCollection services)
        {
            services.TryAddSingleton<StateMachinesClientModel>();
