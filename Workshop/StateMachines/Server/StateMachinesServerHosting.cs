...
{
    /// <summary>
    /// The composition root of the StateMachines server sample: the server class, its
    ...
    /// </remarks>
    public static class StateMachinesServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "StateMachinesServer.Config.xml";

        /// <summary>
        /// Registers the StateMachines server as the hosted OPC UA server of the stack,
        ...
        public static IServiceCollection AddStateMachinesServer(
            this IServiceCollection services,
            string configurationFile = null,
            Action<ApplicationConfiguration> configure = null)
        {
            return services.AddSampleServer<StateMachinesServer>(
                configurationFile ?? ConfigurationFile,
                server => server.AddNodeManager<StateMachinesNodeManagerFactory>(),
                configure);
        }
    }
}