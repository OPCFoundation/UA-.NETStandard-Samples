...
{
    /// <summary>
    /// The composition root of the Empty server sample: the server class, its
    ...
    /// </remarks>
    public static class EmptyServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "Quickstarts.EmptyServer.Config.xml";

        /// <summary>
        /// Registers the Empty server as the hosted OPC UA server of the stack,
        ...
        public static IServiceCollection AddEmptyServer(
            this IServiceCollection services,
            string configurationFile = null,
            Action<ApplicationConfiguration> configure = null)
        {
            return services.AddSampleServer<EmptyServer>(
                configurationFile ?? ConfigurationFile,
                server => server.AddNodeManager<EmptyNodeManagerFactory>(),
                configure);
        }
    }
}