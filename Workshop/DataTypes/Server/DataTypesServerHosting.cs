...
using System;
using Opc.Ua;
using Quickstarts.DataTypes;

namespace Microsoft.Extensions.DependencyInjection
{
    /// <summary>
    /// The composition root of the DataTypes server sample: the server class, its
    ...
    /// </remarks>
    public static class DataTypesServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "DataTypesServer.Config.xml";

        /// <summary>
        /// Registers the DataTypes server as the hosted OPC UA server of the stack,
        ...
        public static IServiceCollection AddDataTypesServer(
            this IServiceCollection services,
            string configurationFile = null,
            Action<ApplicationConfiguration> configure = null)
        {
            return services.AddSampleServer<DataTypesServer>(
                configurationFile ?? ConfigurationFile,
                server => server.AddNodeManager<DataTypesNodeManagerFactory>(),
                configure);
        }
    }
}