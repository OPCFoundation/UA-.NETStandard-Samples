...
{
    /// <summary>
    /// The composition root of the DataTypes client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddDataTypesServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class DataTypesClientHosting
    {
        /// <summary>
        /// Registers the client model of the DataTypes sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddDataTypesClient(this IServiceCollection services)
        {
            services.TryAddSingleton<DataTypesClientModel>();
