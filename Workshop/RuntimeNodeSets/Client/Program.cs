...
namespace Quickstarts.RuntimeNodeSets.Client
{
    ...
    /// <summary>
    /// The <b>RuntimeNodeSets.Client</b> namespace contains a Quickstart Client which loads,
    /// reloads and removes the NodeSet2 model of its server while the server runs.
    /// </summary>
    /// <exclude/>
