...
{
    /// <summary>
    /// The composition root of the RuntimeNodeSets client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddRuntimeNodeSetsServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class RuntimeNodeSetsClientHosting
    {
        /// <summary>
        /// Registers the client model of the RuntimeNodeSets sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddRuntimeNodeSetsClient(this IServiceCollection services)
        {
            services.TryAddSingleton<RuntimeNodeSetsClientModel>();
