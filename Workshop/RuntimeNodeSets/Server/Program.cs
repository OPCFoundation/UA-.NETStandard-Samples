...
namespace Quickstarts.RuntimeNodeSets.Server
{
    ...
    /// <summary>
    /// The <b>RuntimeNodeSets.Server</b> namespace contains a Quickstart Server whose
    /// address space is a pair of NodeSet2 documents loaded at run time, one of which
    /// its clients can reload and remove while the server is running.
    /// </summary>
    /// <exclude/>
