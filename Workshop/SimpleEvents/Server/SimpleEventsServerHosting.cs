...
using System;
using Opc.Ua;
using Quickstarts.SimpleEvents.Server;

namespace Microsoft.Extensions.DependencyInjection
{
    /// <summary>
    /// The composition root of the SimpleEvents server sample: the server class, its
    ...
    /// </remarks>
    public static class SimpleEventsServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "SimpleEventsServer.Config.xml";

        /// <summary>
        /// Registers the SimpleEvents server as the hosted OPC UA server of the stack,
        ...
        public static IServiceCollection AddSimpleEventsServer(
            this IServiceCollection services,
            string configurationFile = null,
            Action<ApplicationConfiguration> configure = null)
        {
            return services.AddSampleServer<SimpleEventsServer>(
                configurationFile ?? ConfigurationFile,
                server => server.AddNodeManager<SimpleEventsNodeManagerFactory>(),
                configure);
        }
    }
}