...
{
    /// <summary>
    /// The composition root of the SimpleEvents client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddSimpleEventsServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class SimpleEventsClientHosting
    {
        /// <summary>
        /// Registers the client model of the SimpleEvents sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddSimpleEventsClient(this IServiceCollection services)
        {
            services.TryAddSingleton<SimpleEventsClientModel>();
