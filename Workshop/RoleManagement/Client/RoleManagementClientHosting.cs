...
{
    /// <summary>
    /// The composition root of the RoleManagement client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddRoleManagementServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class RoleManagementClientHosting
    {
        /// <summary>
        /// Registers the client model of the RoleManagement sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddRoleManagementClient(this IServiceCollection services)
        {
            services.TryAddSingleton<RoleManagementClientModel>();
