...
{
    /// <summary>
    /// The composition root of the RoleManagement server sample: the server class, its
    ...
    public static class RoleManagementServerHosting
    {
        ...
        /// <summary>
        /// Registers the RoleManagement server as the hosted OPC UA server of the stack,
        ...
        {
            return services.AddSampleServer<RoleManagementServer>(
                configurationFile ?? ConfigurationFile,
                server => server.AddNodeManager<RoleManagementNodeManagerFactory>(),
                configure);
        }
    }
}