...
{
    /// <summary>
    /// The composition root of the Views client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddViewsServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class ViewsClientHosting
    {
        /// <summary>
        /// Registers the client model of the Views sample.
        /// </summary>
        /// <param name="services">The service collection.</param>
        public static IServiceCollection AddViewsClient(this IServiceCollection services)
        {
            services.TryAddSingleton<ViewsClientModel>();
