...
using System;
using Opc.Ua;
using Quickstarts.Views.Server;

namespace Microsoft.Extensions.DependencyInjection
{
    /// <summary>
    /// The composition root of the Views server sample: the server class, its
    ...
    /// </remarks>
    public static class ViewsServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "Quickstarts.ViewsServer.Config.xml";

        /// <summary>
        /// Registers the Views server as the hosted OPC UA server of the stack,
        ...
        public static IServiceCollection AddViewsServer(
            this IServiceCollection services,
            string configurationFile = null,
            Action<ApplicationConfiguration> configure = null)
        {
            return services.AddSampleServer<ViewsServer>(
                configurationFile ?? ConfigurationFile,
                server => server.AddNodeManager<ViewsNodeManagerFactory>(),
                configure);
        }
    }
}