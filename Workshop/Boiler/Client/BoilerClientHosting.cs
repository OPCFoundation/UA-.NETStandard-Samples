...
{
    /// <summary>
    /// The composition root of the Boiler client sample: the client model its window
    /// is built on.
    /// </summary>
    /// <remarks>
    /// The counterpart of the <c>AddBoilerServer</c> of the server half. The window
    ...
    /// </remarks>
    public static class BoilerClientHosting
    {
        /// <summary>
        /// Registers the client model of the Boiler sample.
        /// </summary>
