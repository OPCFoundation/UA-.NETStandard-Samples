...
{
    /// <summary>
    /// The composition root of the Boiler server sample: its configuration file and
    ...
    /// registration.
    /// </remarks>
    public static class BoilerServerHosting
    {
        /// <summary>
        /// The application configuration file of the sample.
        /// </summary>
        public const string ConfigurationFile = "BoilerServer.Config.xml";

        /// <summary>
        /// Registers the Boiler server as the hosted OPC UA server of the stack,
